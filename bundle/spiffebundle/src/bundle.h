...
spiffebundle_Bundle *spiffebundle_Parse(const spiffeid_TrustDomain td,
                                        ...
                                        err_t *err);
spiffebundle_Bundle *
spiffebundle_FromX509Bundle(x509bundle_Bundle *bundle);
spiffebundle_Bundle *spiffebundle_FromJWTBundle(jwtbundle_Bundle *bundle);
spiffebundle_Bundle *
spiffebundle_FromX509Authorities(const spiffeid_TrustDomain td,
                                    X509 **auths);
spiffebundle_Bundle *
...
void spiffebundle_Bundle_AddX509Authority(spiffebundle_Bundle *b,
                                            X509 *auth);
...
uint64_t spiffebundle_Bundle_SequenceNumber(spiffebundle_Bundle *b,
                                            bool *suc);
