...
/** workloadapi_X509Source is a source of X509-SVIDs and X.509 bundles maintained via the Workload API.
 * */
typedef struct {
...
/** workloadapi_NewX509Source creates a new X509Source. It blocks until the initial update
...
/** workloadapi_X509Source_Close closes the source, dropping the connection to the Workload API.
...
/** workloadapi_X509Source_WaitUntilUpdated waits until the source is updated or the context is done,
...
/** workloadapi_X509Source_GetX509SVID returns an X509-SVID from the source. It implements the
 *  x509svid.Source interface.
 * */
x509svid_SVID *
workloadapi_X509Source_GetX509SVID(workloadapi_X509Source *source, err_t *err);

/** workloadapi_X509Source_GetX509BundleForTrustDomain returns the X.509 bundle for the given trust
