...
// StreamResponse RequestorRequestStream(workloadapi_Requestor* requestor, Request request, (void*)(*callback)(void*));
// Response RequestorRequest(workloadapi_Requestor* requestor,Request request);

//wrapper methods from gRPC service definition (see proto/workload.proto)
x509svid_SVID* workloadapi_FetchDefaultX509SVID(workloadapi_Requestor* requestor); //not in definition
int workloadapi_FetchAllX509SVID(workloadapi_Requestor* requestor, x509svid_SVID*** svids); //not in definition
// x509svid_SVID_Source* FetchX509SVIDSource(workloadapi_Requestor* requestor);
